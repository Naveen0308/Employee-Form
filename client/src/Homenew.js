...
const Homenew = () => {
    ...
    const handleSubmit = (event) =>{
        ...
        axios.post('https://employee-form-1-v4l8.onrender.com/Homenew',{Ename,Eid,Edept,Edob,Egender,Edesign,Esalary,Eaddress,Elocation,Epincode,Eexperience,Eage})
        .then(res =>{
            navigate('/');
        })
        .catch(err => console.log(err));
    }
// update .js dhan andha file =. adhu ok but enga irundhu andha page ku navigate panra
